// scripts\embed-packager.js
// 处理 sdk-placeholder.html 文件
/* eslint-disable */
...
function convertModule(content) {
  var str = ` (function (global, factory) {
...
module.exports = function (ret, pack, settings, opt) {
  ...
  var tpl = ret.pkg['/build/sdk-placeholder.html'];
  tpl.skiped = true;
  ...
  jsContents = convertModule(jsContents);
